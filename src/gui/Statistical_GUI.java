...
public class Statistical_GUI extends javax.swing.JPanel {
    ...
    public void setJPRevenue() {
        jpTmp.setLayout(new FlowLayout());
        jpTmp.add(statistical_Revenue_GUI);
        jpTmp.revalidate();
        jpTmp.repaint();
        //set JPanel thống kê doạnh thu vào giao diện thống kê
    }

    public void setJPStaff() {
        jpTmp.setLayout(new FlowLayout());
        jpTmp.add(statistical_Staff_GUI);
        jpTmp.revalidate();
        jpTmp.repaint();
        // set JPanel thống kê nhân viên vào giao diện thống kê
    }

    public void setJPProduct() {
        jpTmp.setLayout(new FlowLayout());
        jpTmp.add(statistical_Product_GUI);
        jpTmp.revalidate();
        jpTmp.repaint();
        // set JPanel thống kê sản phẩm vào giao diện thống kê
    }

    public void setJPCustomer() {
        jpTmp.setLayout(new FlowLayout());
        jpTmp.add(statistical_Customer_GUI);
        jpTmp.revalidate();
        jpTmp.repaint();
        // set JPanel thống kê khách hàng vào giao diện thống kê
    }
