...
public class Staff_GUI_X extends javax.swing.JPanel {

    private Staff_Table_GUI_X staff_Table_GUI;
    private Staff_InfoStaff_GUI_X staff_InfoStaff_GUI;
//    private Staff_InfoStaff_GUI1 staff_InfoStaff_GUI;
    public Staff_GUI_X() {
        initComponents();

        staff_Table_GUI = new Staff_Table_GUI_X();
        jpTMP.removeAll();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        staff_InfoStaff_GUI = new Staff_InfoStaff_GUI_X();
