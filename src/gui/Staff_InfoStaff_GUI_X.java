...
public class Staff_InfoStaff_GUI_X extends javax.swing.JFrame {
        ...
        jpInfoStaffLayout.setHorizontalGroup(
            ...
            .addGroup(jpInfoStaffLayout.createSequentialGroup()
                ...
                .addGroup(jpInfoStaffLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpInfoStaffLayout.createSequentialGroup()
                        .addComponent(cbProvince, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(cbDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(cbWard, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void cbDistrictItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbDistrictItemStateChanged
        ...
        if (nameDistrictSelected.equals(District.getDistrictLabel())) {
            ...
            Staff_InfoStaff_GUI_X.this.district = district;
    ...
    private void cbProvinceItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbProvinceItemStateChanged
        ...
        Staff_InfoStaff_GUI_X.this.province = province;

        try {
            setDistrictToComboBox(Staff_InfoStaff_GUI_X.this.province);
    ...
    private void cbWardItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbWardItemStateChanged
        ...
        Staff_InfoStaff_GUI_X.this.ward = ward;
        isEnabledEventWard = false;
