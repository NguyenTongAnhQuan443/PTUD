...
public class Product_Detail_GUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jtfIDProduct = new Customs.TextField();
        jtfPrice = new Customs.TextField();
        cbColor = new Customs.ComboBoxSuggestion();
        jtfNameProduct = new Customs.TextField();
        jtfNumber = new Customs.TextField();
        cbType = new Customs.ComboBoxSuggestion();
        cbMaterial = new Customs.ComboBoxSuggestion();
        cbSize = new Customs.ComboBoxSuggestion();
        jpBottom = new javax.swing.JPanel();
        jspTable = new javax.swing.JScrollPane();
        jTable1 = new javax.swing.JTable();
        btnAdd = new Customs.Button();
        btnDel = new Customs.Button();
        btnInputFile = new Customs.Button();
        btnEdit = new Customs.Button();
        btnSearch = new Customs.Button();
        btnOutputFile = new Customs.Button();
    ...
    private Customs.Button btnDel;
    private Customs.Button btnEdit;
    private Customs.Button btnInputFile;
    private Customs.Button btnOutputFile;
    private Customs.Button btnSearch;
    private Customs.ComboBoxSuggestion cbColor;
    private Customs.ComboBoxSuggestion cbMaterial;
    private Customs.ComboBoxSuggestion cbSize;
    private Customs.ComboBoxSuggestion cbType;
    private javax.swing.JTable jTable1;
    private javax.swing.JPanel jpBottom;
    private javax.swing.JPanel jpTop;
    private javax.swing.JScrollPane jspTable;
    private Customs.TextField jtfIDProduct;
    private Customs.TextField jtfNameProduct;
    private Customs.TextField jtfNumber;
    private Customs.TextField jtfPrice;
